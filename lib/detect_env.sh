...
detect_env() {
  ...
  # other.
  # shellcheck disable=SC2034 # read by .config/.zshrc.d/2_functions.zsh, 5_general.zsh, 7_final.zsh, .zprofile -- one directive covers the whole case (SC1124: a directive cannot sit on a case-arm line)
  case "${hn}" in
