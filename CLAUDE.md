...
- `test` job: installs bats + shellcheck, runs `make test`, then verifies test count ≥ 840 (regression proxy; 953 tests as of 2026-07-19)
...
- **Overall: 90%** (953 tests as of 2026-07-19); gated in CI at 90% (`bash-coverage` job, blocks auto-merge on drop).
