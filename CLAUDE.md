...
- **Overall: 90%** (measured 2026-05-30 across 709 BATS tests using `make bash-coverage`; per-file: `setup_env.sh` 89%, `helpers.sh` 86%, `workflows.sh` 85%, `update_summary.sh` 97%, `developer.sh` 91%, `linux_ubuntu.sh` 91%, `macos.sh` 87%→90%+, `constants.sh`/`detect_env.sh`/`linux_shared.sh` 96-100%)
