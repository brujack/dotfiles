...
- `test` job: installs a pinned, checksum-verified shellcheck plus bats, runs `make test`, then verifies test count >= 840 (regression proxy; 1626 tests, CI-measured 2026-09-10 on `971d789f`, run 34500582029, job 102950060886; that branch SHA was squash-merged and is no longer an ancestor of master — it landed as `9a7a2a0c`, #259)
