...
- `test` job: installs a pinned, checksum-verified shellcheck plus bats, runs `make test`, then verifies test count ≥ 840 (regression proxy; 1641 tests, CI-measured 2026-09-03 on `1a832a72`, run 33797748409)
