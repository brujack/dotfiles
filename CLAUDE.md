...
- `test` job: installs bats + shellcheck, runs `make test`, then verifies test count ≥ 840 (regression proxy; 1056 tests as of 2026-07-29)
...
- **Overall: 91%** (1056 tests as of 2026-07-29); gated in CI at 90% (`bash-coverage` job, blocks auto-merge on drop).
