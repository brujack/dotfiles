...
- `test` job: installs bats + shellcheck, runs `make test`, then verifies test count ≥ 840 (regression proxy; 1105 tests as of 2026-07-31)
...
- **Overall: 91%** (1105 tests as of 2026-07-31); gated in CI at 90% (`bash-coverage` job, blocks auto-merge on drop).
