...
- `test` job: installs bats + shellcheck, runs `make test`, then verifies test count ≥ 840 (regression proxy; 1127 tests as of 2026-08-01)
...
- **Overall: 91%** (1127 tests as of 2026-08-01); gated in CI at 90% (`bash-coverage` job, blocks auto-merge on drop).
