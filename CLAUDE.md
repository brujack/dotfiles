...
- `test` job: installs a pinned, checksum-verified shellcheck plus bats, runs `make test`, then verifies test count >= 840 (regression proxy; 1622 tests, CI-measured 2026-09-10 on `e90e5d1a`, run 34438891646, job 102755003116; that branch SHA was squash-merged and is no longer an ancestor of master — it landed as `30862618`, #258)
