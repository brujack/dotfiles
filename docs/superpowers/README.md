...
| Feature                       | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| coverage-workflows-gaps       | `workflows.sh` at 79% (floor 90%). Uncovered: `setup_claude_mcp` envsubst-not-found branch (existing test stubs envsubst as a function so `command -v` always succeeds); `run_setup_user` cheat.sh download block (`curl cht.sh`, chmod, zsh `_cht` conditional) and `install_zsh` call; `run_update` run_all block missing `setup_ai_config`/`update_aws_cli`/`update_rust` coverage.                                                                                                                                                       |
| coverage-update-summary-casks | `update_summary.sh` at 82% (floor 90%). Remaining uncovered: `_update_check_brewfile_drift` cask drift sections — detail output loops for untracked/missing casks (lines 553–583) and untracked/missing taps (lines 568–596); cask count summary building; `brew not available` skip path (line 467–470).                                                                                                                                                                                                                                    |
