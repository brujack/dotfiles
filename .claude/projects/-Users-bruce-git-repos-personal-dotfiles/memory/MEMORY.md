...
- [Mock pass-through for filesystem commands](feedback_mock_passthrough.md) — ln/chmod/mv/cp mocks must call real binary; log-only mocks cause silent test failures when assertions check real filesystem state
- [Dotfiles PRs 19 and 20](project_dotfiles_prs.md) — workflows refactor (1437→343 lines) and interactive version update, both pending CI merge 2026-04-10
