...
**Why:** From the Cursor next-steps doc (2026-04-08-dotfiles-next-steps-plan.md). User requested specs and plans, then asked to implement secrets first, then plan hygiene.

**How to apply:** Next session can pick up A, B, or D. Recommended order: PR A (workflows) then PR D (CI safety) then PR B (doctor/dry-run). Status is now visible in docs/superpowers/README.md.
