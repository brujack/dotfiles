...
**All done as of 2026-04-09:**
- PR #5: secrets guardrails
- PR #6: plan hygiene (adds docs/superpowers/README.md)
- PR #7: lib/workflows.sh extraction
- PR #8: CI safety pass
- PR #9: doctor + dry-run support
...
**How to apply:** Remaining implementation order: local-overrides (simplest) → granular-update-flags → doctor-enhanced → workflow-test-coverage.
