...
alias talogin='export ANSIBLE_SSH_ARGS="-F ${HOME}/.ssh/teleport.cfg" && export ANSIBLE_SCP_IF_SSH=False && export ANSIBLE_HOST_KEY_CHECKING=False && tsh login --proxy=teleport.conecrazy.io --user=teleport-admin --insecure'
